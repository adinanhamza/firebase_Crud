...
class Profile extends StatelessWidget {
  ...
  String clas;
  String address;
   Profile({super.key,required this.address,required this.age,required this.clas,required this.name,required this.id});
          ...
          Row(
            children: [
              Consumer<StudentProvider>(
                ...
                Navigator.push(context, MaterialPageRoute(builder: (context)=> Update(address: address, age: age, name: name, id:id, clas: clas)));
